-- [[ SYAAA HUB V7.7 - PURPLE THEME (FIXED OUT OF LOCAL REGISTERS & CUSTOM TITLE) ]] --
...
local function runSyaaHub()
    ...
    local function makeSidebarIcon(assetId, yPos, tabName, customSize)
        ...
        btn.BackgroundTransparency = 1; btn.Image = assetId; btn.ImageColor3 = Color3.fromRGB(150, 40, 255)
        btn.Parent = sidebar
        task.spawn(function()
            while true do
                TweenService:Create(btn, TweenInfo.new(1.5), {ImageColor3 = Color3.fromRGB(255,255,255)}):Play(); task.wait(1.5)
                TweenService:Create(btn, TweenInfo.new(1.5), {ImageColor3 = Color3.fromRGB(150,40,255)}):Play(); task.wait(1.5)
            end
        end)
    ...
    local function createPanel(name)
        ...
        panel.BackgroundTransparency = 1; panel.ScrollBarThickness = 3; panel.ScrollBarImageColor3 = Color3.fromRGB(150,40,255)
    ...
    local titleMode = 1
    local tColors = {
        {n="Ungu", c=Color3.fromRGB(150,40,255)}, {n="Biru", c=Color3.fromRGB(50,150,255)},
    ...
    local function buildToolsPanel()
        ...
        local titleInput = Instance.new("TextBox"); titleInput.Size = UDim2.new(0.92, 0, 0, 30); titleInput.Position = UDim2.new(0.04, 0, 0, tY); titleInput.BackgroundColor3 = Color3.fromRGB(20, 10, 30); titleInput.TextColor3 = Color3.fromRGB(255, 255, 255); titleInput.PlaceholderText = "Tulis Title di sini..."; titleInput.Text = "SYAA HUB"; titleInput.Font = Enum.Font.GothamBold; titleInput.TextSize = 11; titleInput.Parent = pTools; Instance.new("UICorner", titleInput); Instance.new("UIStroke", titleInput).Color = Color3.fromRGB(130,40,255)
        tY = tY + 36
        ...
        local tsBg = Instance.new("Frame"); tsBg.Size = UDim2.new(0.88,0,0,4); tsBg.Position = UDim2.new(0.06,0,0,tY); tsBg.BackgroundColor3 = Color3.fromRGB(30,20,40); tsBg.Parent = pTools; Instance.new("UICorner",tsBg)
        local tsFill = Instance.new("Frame"); tsFill.Size = UDim2.new(0.33,0,1,0); tsFill.BackgroundColor3 = Color3.fromRGB(150,40,255); tsFill.BorderSizePixel = 0; tsFill.Parent = tsBg; Instance.new("UICorner",tsFill)
        ...
        local tyBg = Instance.new("Frame"); tyBg.Size = UDim2.new(0.88,0,0,4); tyBg.Position = UDim2.new(0.06,0,0,tY); tyBg.BackgroundColor3 = Color3.fromRGB(30,20,40); tyBg.Parent = pTools; Instance.new("UICorner",tyBg)
        local tyFill = Instance.new("Frame"); tyFill.Size = UDim2.new(0.2,0,1,0); tyFill.BackgroundColor3 = Color3.fromRGB(150,40,255); tyFill.BorderSizePixel = 0; tyFill.Parent = tyBg; Instance.new("UICorner",tyFill)
        ...
        local flyBtn = Instance.new("TextButton"); flyBtn.Text = "🚀 Load Fly"; flyBtn.Size = UDim2.new(0.92,0,0,30); flyBtn.Position = UDim2.new(0.04,0,0,tY); flyBtn.BackgroundColor3 = Color3.fromRGB(130,40,255); flyBtn.BackgroundTransparency = 0.5; flyBtn.TextColor3 = Color3.fromRGB(255,255,255); flyBtn.Font = Enum.Font.GothamBold; flyBtn.TextSize = 10; flyBtn.Parent = pTools; Instance.new("UICorner", flyBtn).CornerRadius = UDim.new(0,6); tY = tY + 36
        ...
        local emoteBtn = Instance.new("TextButton"); emoteBtn.Text = "🕺 Load Emote"; emoteBtn.Size = UDim2.new(0.92,0,0,30); emoteBtn.Position = UDim2.new(0.04,0,0,tY); emoteBtn.BackgroundColor3 = Color3.fromRGB(130,40,255); emoteBtn.BackgroundTransparency = 0.5; emoteBtn.TextColor3 = Color3.fromRGB(255,255,255); emoteBtn.Font = Enum.Font.GothamBold; emoteBtn.TextSize = 10; emoteBtn.Parent = pTools; Instance.new("UICorner", emoteBtn).CornerRadius = UDim.new(0,6); tY = tY + 36
